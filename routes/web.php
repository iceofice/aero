...
Route::group(['middleware' => 'auth'], function() {
    ...
    //Route::post('blog/detail/{blog}', 'BlogController@edit');
});
...
//Route::get('blog/new-post', 'BlogController@newPost')->name('blog.new-post');
Route::post('blog/new-post', 'BlogController@post');
...
Route::post('blog/detail/{blog}/edit', 'BlogController@update');
Route::get('blog/detail/{blog}', 'BlogController@details');
Route::delete('blog/detail/{blog}/edit','BlogController@delete');
Route::post('blog/detail/{blog}', 'BlogController@edit');
...
Route::post('authentication/login', 'AuthenticationController@signin');
Route::get('authentication/register', 'AuthenticationController@register')->name('authentication.register');
Route::post('authentication/register', 'AuthenticationController@update');
