...
<aside id="leftsidebar" class="sidebar">
    <div class="navbar-brand">
        ...
        <a href="{{route('dashboard.index')}}"><img src="{{asset('assets/images/logo.svg')}}" width="25" alt="Aero"><span class="m-l-10">Aero</span></a>
    </div>
    <div class="menu">
        <ul class="list">
            <li>
                <div class="user-info">
                    ...
                    <div class="detail">
                        ...
                        @else
                            <a href="{{route('authentication.login')}}">Please login</a>
                        @endif
                    </div>
                </div>
            </li>            
